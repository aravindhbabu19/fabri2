...
const Project = () => {
  return (
    ...
    <div class='project-div'>
        <h1 class='project-head11 ms-5 pt-5'> PRECISION <span class='service-span'>MEETS</span> PERFORMANCE</h1>
    ...
    <div class='project-div1'>
      ...
      <div class='row ms-3'>
        <div class='project-col1  col-12 col-sm-12 col-md-6 col-lg-4 pb-4'>
          <div>
      ...
      <div class='row ms-3 pt-5 pb-5'>
        <div class='project-col1 col-12 col-sm-12 col-md-6 col-lg-4 pb-4'>
          <div>
           <img src='./Images/Fab/project5.jpeg' alt='' height={350} width={350} class='project-imag '/>
          </div>
          <h5 class='project-head5 '>Badminton Court</h5>
        </div>
        <div class='project-col1 col-12 col-sm-12 col-md-6 col-lg-4 pb-4'>
          <div>
           <img src='./Images/Fab/project6.jpeg' alt='' height={350} width={350} class='project-imag '/>
          </div>
          <h5 class='project-head5 '>Swimming Pool</h5>
        </div>
        <div class='project-col1 col-12 col-sm-12 col-md-6 col-lg-4 pb-4'>
          <div>
           <img src='./Images/Fab/table.jpeg' alt='' height={350} width={350} class='project-imag '/>
          </div>
