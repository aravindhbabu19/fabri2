...
const Contact = () => {
 ...
 const handleSubmit=(e)=>{
  const number="+919019500835"
    e.preventDefault()
    axios.post('https://fabri5.onrender.com/api/v1/Fabrication',{name,email,contact,message})
    .then((result)=>{
        console.log(result)
  ...
  return (
    <div>
      <div class='contact-div'>
        <h1 class='contact-head11 ms-5 pt-5'> PRECISION <span class='service-span'>MEETS</span> PERFORMANCE</h1>
