...
const Home = () => {
 ...
 const goToSlide = (index) => {
  ...
  return (
    <div class='homr'>
       <div class='home-div'>
        <h1 class='home-head11 ms-5 pt-5'>  QUALITY IRON <span class='service-span'>&</span> STEEL FABRICATION WORKS</h1>
       ...
       <div class='home-div1'>
        <div class='row'>
          <div class='col-12 col-sm-12 col-md-6 col-lg-6'>
            <img src='./Images/Fab/weld10.jpeg' alt='' height={300} width={300} class='aboutus-img mt-5 ms-5'/>
          </div>
      ...
      <div class='row'>
        ...
        <div class='col-12 col-sm-12 col-md-4 col-lg-3 pb-5'>
          <div class='d-flex justify-content-center'>
