  ...
  return (
    <div>
      <div class='service-div'>
        <h1 class='service-head ms-5 pt-5'> PRECISION <span class='service-span'>MEETS</span> PERFORMANCE</h1>
      ...
      <div class='row ser-col'>
        ...
        <div class='col-12 col-sm-12 col-md-4 col-lg-3'>
          <div class='d-flex justify-content-center'>
          <img src='./Images/Fab/food1.jpg' alt='' height={250} width={250} class='service-img mt-5'/>
          </div>
          <h5 class='service-head5 d-flex justify-content-center '>Food Cart</h5>
        </div>
        <div class='col-12 col-sm-12 col-md-4 col-lg-3'>
          <div class='d-flex justify-content-center'>
          <img src='./Images/Fab/food.jpg' alt='' height={250} width={250} class='service-img mt-5'/>
          </div>
          <h5 class='service-head51 ms-5 d-flex justify-content-center '>Portable food Cabin</h5>
        </div>
      </div>
      <div class='row'>
        <div class='col-12 col-sm-12 col-md-4 col-lg-3'>
          <div class='d-flex justify-content-center'>
          <img src='./Images/Fab/fod.jpg' alt='' height={250} width={250} class='service-img mt-5'/>
          </div>
          <h5 class='service-head5 d-flex justify-content-center '>Food Truck</h5>
        </div>
        <div class='col-12 col-sm-12 col-md-4 col-lg-3'>
          <div class='d-flex justify-content-center'>
          <img src='./Images/Fab/double.jpg' alt='' height={250} width={250} class='service-img mt-5'/>
          </div>
          <h5 class='service-head5 d-flex justify-content-center '>Food truck double Tucker</h5>
        </div>
        <div class='col-12 col-sm-12 col-md-4 col-lg-3'>
          <div class='d-flex justify-content-center'>
      ...
      <div class='row'>
        <div class='col-12 col-sm-12 col-md-4 col-lg-3'>
          <div class='d-flex justify-content-center'>
          <img src='./Images/Fab/cust.jpeg' alt='' height={250} width={250} class='service-img mt-5'/>
          </div>
      ...
      <div class='row pb-4'>
        ...
        <div class='col-12 col-sm-12 col-md-4 col-lg-3'>
         ...
         <div class='col-12 col-sm-12 col-md-4 col-lg-3'>
          <div class='d-flex justify-content-center'>
          <img src='./Images/Fab/table.jpeg' alt='' height={250} width={250} class='service-img mt-5'/>
          </div>
      ...
      {/* <div class='row mt-4'>
        ...
        <h1 class='service-head2 mt-3 ms-5 pt-5'>CONTACT US</h1>
        <p class='service-para mt-5 ms-5'>Reach Out to us for all your enquiries.<br></br> Our team will guide you through the process</p>
        <p class='service-para'> <FaLocationDot class='service-icon ms-5' />LAKSHMI ENTERPRISES #197 1st Cross, Kenchanapura cross,<br></br><p class='ms-5'>Jnana Jyothi Nagar Ullal, 80ft Ring Road Bengaluru-56,Karnataka</p></p>
        <p class='service-para mt-4 ms-5'><FaPhone class='service-icon1'/>Mob:9019500835,8453498863</p>
        <Link class='text-decoration-none' to={'/Contact'}>
        <button class='service-button ms-5 mt-3'><a class="nav-link" href="">Contact Us</a></button>
        </Link>
        </div>
        <div class='col-12 col-lg-6'>
          <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3889.9098488047257!2d77.67102277320713!3d12.849099017555988!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bae6d65e52471eb%3A0xc0862426203a874f!2sSrinivasa%20Luxury%20PG%20Gents!5e0!3m2!1sen!2sin!4v1750399401580!5m2!1sen!2sin" class='service-map' allowfullscreen="" title='add' loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </div>
      </div> */}
      </div>
    </div>
